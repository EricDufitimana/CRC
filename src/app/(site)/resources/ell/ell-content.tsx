...
export function ELLContent() {
  const { data, isLoading, error, refetch } = useTRPCRealtime<EnglishResource>({
    ...
    return (
      <div className="content w-[1100px] max-w-[90%] mx-auto">
        <EmptyState
          ...
          headerText="No English learning resources available"
          subtext="We're constantly adding new resources to help improve your English skills. Check back soon for study materials and learning tools."
