          ...
          <div className="lg:col-span-1 p-6 lg:p-8 bg-white">
            <div className="h-full flex flex-col">
              ...
              <div className="mb-6">
                ...
                <DialogTitle className="text-2xl md:text-3xl font-bold text-gray-900 mt-4 mb-4 leading-tight">
                  {event.title}
                </DialogTitle>
                ...
                {event.event_organizer && (
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">{event.event_organizer.name}</p>
                        {event.event_organizer.role && (
                          <p className="text-sm text-gray-600">{event.event_organizer.role}</p>
                        )}
                      </div>
                    </div>
                  </div>
