...
export function BetaStudentBottomNav() {
  const router = useRouter();
  const pathname = usePathname() ?? "";

  const isDashboard = (p: string) => p === "/demo/student";
  const isAssignments = (p: string) => p.startsWith("/demo/student/assignments");
  const isRequests = (p: string) => p.startsWith("/demo/student/requests");
  const isDocuments = (p: string) => p.startsWith("/demo/student/documents");

  const primaryPhone: NavItem[] = [
    { label: "Home", href: "/demo/student", icon: LayoutDashboard, isActive: isDashboard },
    { label: "Tasks", href: "/demo/student/assignments", icon: ClipboardList, isActive: isAssignments },
    { label: "Requests", href: "/demo/student/requests", icon: Briefcase, isActive: isRequests },
  ];
                ...
                <div className="max-w-xl mx-auto">
                  ...
                  <div className="px-6 pb-6 pt-4 grid grid-cols-2 gap-3">
                    <Button
                      ...
                      onClick={() => router.push("/demo/student/documents")}
                    >
...
export function BetaStudentBottomNavTablet() {
  const router = useRouter();
  const pathname = usePathname() ?? "";
  ...
  const primaryTablet: NavItem[] = [
    ...
    { label: "Tasks", href: "/demo/student/assignments", icon: ClipboardList, isActive: isAssignments },
    { label: "Requests", href: "/demo/student/requests", icon: Briefcase, isActive: isRequests },
    { label: "Files", href: "/demo/student/documents", icon: Folder, isActive: isDocuments },
  ];
