    ...
    <div className="border border-gray-300/80 rounded-lg bg-white/80 backdrop-blur-sm dark:border-gray-600/80 dark:bg-gray-800/80">
      <Table>
        <TableHeader className="bg-white/80 dark:bg-gray-800/80">
          <TableRow>
            <TableHead className="w-10 bg-white/80 dark:bg-gray-800/80 rounded-lg text-xs py-2">
              <div className="flex items-center justify-center">
                <Checkbox 
                  checked={allSelected} 
                  onCheckedChange={onSelectAll} 
                  className="h-3.5 w-3.5 border-black data-[state=checked]:text-white data-[state=checked]:border-white dark:border-gray-400"
                />
              </div>
            </TableHead>
            <TableHead className="bg-white/80 dark:bg-gray-800/80 text-gray-600 dark:text-gray-300 text-xs py-2 pl-3">Name</TableHead>
            <TableHead className="bg-white/80 dark:bg-gray-800/80 text-gray-600 dark:text-gray-300 text-xs py-2">Grade</TableHead>
            <TableHead className="bg-white/80 dark:bg-gray-800/80 text-gray-600 dark:text-gray-300 text-xs py-2">Major</TableHead>
            <TableHead className="bg-white/80 dark:bg-gray-800/80 text-gray-600 dark:text-gray-300 text-xs py-2">GPA</TableHead>
            <TableHead className="bg-white/80 dark:bg-gray-800/80 rounded-lg text-gray-600 dark:text-gray-300 text-xs py-2">View</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {loading ? (
            ...
            students.map(student => (
              <TableRow key={student.id}>
                <TableCell className="bg-white/80 dark:bg-gray-800/80 rounded-lg py-2">
                  <div className="flex items-center justify-center">
                    <Checkbox 
                ...
                <TableCell className="font-medium bg-white/80 dark:bg-gray-800/80 text-sm py-4 pl-3">
                ...
                <TableCell className="bg-white/80 dark:bg-gray-800/80 py-2">
                  <Badge variant="outline" className={`${getGradeColor(student.grade || '')} text-xs px-1.5 py-0.5`}>
                    {student.grade || 'N/A'}
                  </Badge>
                </TableCell>
                <TableCell className="bg-white/80 dark:bg-gray-800/80 dark:text-white text-sm py-2">
                ...
                <TableCell className="bg-white/80 dark:bg-gray-800/80 rounded-lg py-2">
                  <div className="flex gap-1.5">
                    <Button 
                      variant="outline" 
                      size="sm" 
                      className="gap-1 h-7 px-2 text-xs dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700"
