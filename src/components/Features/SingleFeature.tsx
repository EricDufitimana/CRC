    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
      <OptimizedScrollAnimation direction="right" delay={400}>
        <div className="group mb-12">
          <div className={`relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-primary will-change-transfrm ${isMobile ? 'mx-auto' : ''}`}>
          ...
          <OptimizedAnimatedText
            ...
            as="h3"
            className={`mb-3 text-xl font-bold text-dark dark:text-white ${isMobile ? 'text-center' : ''}`}
            delay={100}
          >
            {title}
          </OptimizedAnimatedText>
          <OptimizedAnimatedText
            animation="slide-right"
            as="p"
            className={`mb-8 text-body-color dark:text-dark-6 lg:mb-11 ${isMobile ? 'text-center' : ''}`}
            delay={100}
          >
            {paragraph}
          </OptimizedAnimatedText>
