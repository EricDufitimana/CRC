  ...
  theme: {
    extend: {
      ...
      screens: {
        ...
        'tablet': '768px',
        'laptop': '1024px',
        'laptop-lg': '1366px', // Your specific laptop width
        'desktop': '1280px',
        'wide': '1920px',

        'h-short': {'raw': '(max-height: 650px)'}, // Your laptop height range
        'h-xs': {'raw': '(max-height: 500px)'}, // Very short screens
        'h-sm': {'raw': '(min-height: 501px) and (max-height: 650px)'}, // Your laptop
        
        // Medium heights (tablets, normal laptops)
        'h-md': {'raw': '(min-height: 651px) and (max-height: 800px)'},
        'h-lg': {'raw': '(min-height: 801px) and (max-height: 1000px)'},
      },	
      fontFamily: {
